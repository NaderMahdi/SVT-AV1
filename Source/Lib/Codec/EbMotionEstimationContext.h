...
#endif
#if NSQ_OPTIMASATION
        uint32_t                      p_sb_best_nsq[MAX_NUM_OF_REF_PIC_LIST][MAX_REF_IDX][MAX_ME_PU_COUNT];
        uint32_t                     *p_best_nsq8x8;
        uint32_t                     *p_best_nsq16x16;
        uint32_t                     *p_best_nsq32x32;
        uint32_t                     *p_best_nsq64x64;
#endif
